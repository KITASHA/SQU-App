class GigsController < ApplicationController
  ...
  def gig_params
    params.require(:gig).permit(:gig_name, :date, :start_time, :end_time, :location, :description, :link_name_1, :link_url_1, :link_name_2, :link_url_2, :link_name_3, :link_url_3, images: [], band_ids: [])
  end
